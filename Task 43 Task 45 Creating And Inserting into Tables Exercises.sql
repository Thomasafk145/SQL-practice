...
insert into campers values(102, 'Priya',  'Shah',    95.00, '2025-06-10'),
       (103, 'Jordan', 'Lee',     72.25, '2025-06-11'),
       (104, 'Mateo',  'Garcia',  80.00, '2025-06-11'),
       (105, 'Sakura', 'Tanaka',  99.99, '2025-06-12')  on duplicate key update camper_id = camper_id;

/* 14) Insert with specific columns only.
   - Insert a row with ONLY camper_id, first_name, last_name (leave others NULL):
*/
insert into campers (camper_id,first_name, last_name) values (500,"jordan","klemm")on duplicate key update camper_id = camper_id;
...
-- Answer
-- Bad Attempt:
insert into campers values ("dakota",0.67,"kuhn", 160, "2025-10-19");
-- Good Attempt:
insert into campers (first_name,daily_rate, last_name,camper_id,start_date ) values ("dakota",0.67,"kuhn", 160,"2025-10-19");
select * from campers;
/* 17) Drop a table.
